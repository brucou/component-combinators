...
export function InjectCircularSources(injectCircularSourcesSettings, componentTree) {
  // TODO : contract, include optionality
  assertContract(isCircularSourcesSettings, [injectCircularSourcesSettings], injectCircularSourcesError);

  // TODO : contract, include default values, because of optionslity
  const {behaviourSourceName, processingBehaviourFn, initialBehaviorValue} = injectCircularSourcesSettings.behaviour;
  const finalizeBehaviourSource = injectCircularSourcesSettings.behaviour.finalizeBehaviourSource || noop;
